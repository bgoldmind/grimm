...
namespace grimm::wallet
{
    ...
    struct IPrivateKeyKeeper
    {
        ...
        virtual void GenerateOutputs(Height schemeHeigh, const std::vector<Key::IDV>& ids, grimm::AssetID assetId, Callback<Outputs>&&, ExceptionCallback&&) = 0;
        ...
        virtual Outputs GenerateOutputsSync(Height schemeHeigh, const std::vector<Key::IDV>& ids, grimm::AssetID assetId) = 0;
    ...
    private:
        ...
        void GenerateOutputs(Height schemeHeight, const std::vector<Key::IDV>& ids, grimm::AssetID assetId, Callback<Outputs>&&, ExceptionCallback&&) override;
        ...
        Outputs GenerateOutputsSync(Height schemeHeigh, const std::vector<Key::IDV>& ids, grimm::AssetID assetId) override;
